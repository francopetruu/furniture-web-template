...
export function WhatsAppFloat() {
  ...
  const defaultMessage = "¡Hola! Me gustaría conocer más sobre sus muebles."
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <button
        ...
        className="absolute -top-2 -right-2 bg-gray-600 hover:bg-gray-700 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs"
